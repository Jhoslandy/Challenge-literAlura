...
public class Principal {
    ...
    public void muestraElMenu() {
        ...
        while (opcion != 0) {
            var menu = """
                    ...
                    4 - Listar autores desde un anio X
    ...
    private void listarLibrosPorIdioma() {
        System.out.println("""
                Idiomas disponibles a buscar del libro: 
                es - Español
                en - Inglés
                pt - Portugués
                fr - Francés
    ...
    private void listarAutoresPorAnio() {
        System.out.println("Escribe el anio de busqueda:");
        var anio = teclado.nextInt();
        teclado.nextLine();
        List<Autor> autoresVivos = autorRepository.findAuthorsAliveInYear(anio);
        if (autoresVivos.isEmpty()) {
            System.out.println("No se encontraron autores vivos de ese año");
        } else {
    ...
    private void buscarLibros() {
        ...
        if (datosLibro != null && datosLibro.titulo() != null) {
            ...
            try {
                ...
                System.out.println("Libro guardado existosamente");
                System.out.println(libro);
            } catch (Exception e) {
